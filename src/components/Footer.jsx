...
export default function Footer() {
  return (
    <footer className="glass text-white mt-20">
      {/* Main Footer Content */}
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* Quick Links */}
          <div className="space-y-4">
            <h4 className="text-lg font-semibold text-[#00d4ff]">Quick Links</h4>
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/projects" className="text-gray-300 hover:text-white transition-colors duration-300 text-sm">
                  Projeler
                </Link>
              </li>
              <li>
          ...
          {/* Services */}
          <div className="space-y-4">
            <h4 className="text-lg font-semibold text-[#00d4ff]">Services</h4>
            <ul className="space-y-2">
          ...
          {/* Contact Info */}
          <div className="space-y-4">
            <h4 className="text-lg font-semibold text-[#00d4ff]">Contact</h4>
